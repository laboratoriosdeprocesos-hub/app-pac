  ...
  <div class="tank-panel">
    <div class="card" style="width:100%;display:flex;flex-direction:column;align-items:center;gap:7px;padding:11px 8px">
      ...
      <svg viewBox="0 0 280 380" xmlns="http://www.w3.org/2000/svg"
        ...
        <text x="{TX+TW+18}" y="{y_rebose+4:.1f}" font-size="7"
        ...
        <text x="{TX+TW+18}" y="{y_minima+4:.1f}" font-size="7"
        ...
        <text x="{TX+TW+18}" y="{y_obj+4:.1f}" font-size="7"
